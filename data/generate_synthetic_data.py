data = {
    "input": [
      # Entry 1: Low Band (4.5) - Problem/Solution
...
""",
      # Entry 2: Mid-Low Band (5.0) - Agree/Disagree
      """Rate this IELTS essay:
...
""",
      # Entry 3: Mid Band (6.0) - Discuss Both Views
      """Rate this IELTS essay:
...
""",
      # Entry 4: Mid-High Band (7.0) - Advantages/Disadvantages
      """Rate this IELTS essay:
...
""",
      # Entry 5: High Band (8.5) - Problem/Solution
      """Rate this IELTS essay:
...
""",
      # Entry 6: Band 5.5 - Agree/Disagree
      """Rate this IELTS essay:
...
""",
      # Entry 7: Band 7.5 - Discuss Both Views
      """Rate this IELTS essay:
...
""",
      # Entry 8: Band 4.0 - Advantages/Disadvantages
      """Rate this IELTS essay:
...
""",
      # Entry 9: Band 6.5 - Problem/Solution
      """Rate this IELTS essay:
...
""",
      # Entry 10: Band 8.0 - Agree/Disagree
      """Rate this IELTS essay:
...
""",
      # Entry 11: Band 5.0 - Discuss Both Views
      """Rate this IELTS essay:
...
""",
      # Entry 12: Band 9.0 - Advantages/Disadvantages
      """Rate this IELTS essay:
...
""",
      # Entry 13: Band 6.0 - Problem/Solution
      """Rate this IELTS essay:
...
""",
      # Entry 14: Band 7.0 - Agree/Disagree
      """Rate this IELTS essay:
...
""",
      # Entry 15: Band 4.5 - Discuss Both Views
      """Rate this IELTS essay:
...
""",
      # Entry 16: Band 8.0 - Problem/Solution
      """Rate this IELTS essay:
...
""",
      # Entry 17: Band 5.5 - Advantages/Disadvantages
      """Rate this IELTS essay:
...
""",
      # Entry 18: Band 7.5 - Agree/Disagree
      """Rate this IELTS essay:
...
""",
      # Entry 19: Band 6.5 - Discuss Both Views
      """Rate this IELTS essay:
...
""",
      # Entry 20: Band 4.0 - Agree/Disagree
      """Rate this IELTS essay:
...
"""
    ...
    "output": [
      # Entry 1: Score for Low Band (4.5)
...
Overall Band Score: 4.5""",
      # Entry 2: Score for Mid-Low Band (5.0)
...
Overall Band Score: 5.0""",
      # Entry 3: Score for Mid Band (6.0)
...
Overall Band Score: 6.0""",
      # Entry 4: Score for Mid-High Band (7.0)
...
Overall Band Score: 7.0""",
      # Entry 5: Score for High Band (8.5)
